...
package com.glasspixel.glasspixeldungeon.android;
...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			SPDSettings.set(instance.getPreferences(GlassPixelDungeon"));
		...
		initialize(new GlassPixelDungeon(support), config);
