...
package com.glasspixel.glasspixeldungeon.messages;
...
public class Messages {
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.glasspixel.glasspixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
	...
	public static String format( String format, Object...args ) {
		try {
			...
			GlassPixelDungeon.reportException( new Exception("formatting error for the string: " + format, e) );
			return format;
		}
	}
