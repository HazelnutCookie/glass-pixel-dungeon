...
package com.glasspixel.glasspixeldungeon.items.artifacts;
...
import com.glasspixel.glasspixeldungeon.actors.mobs.Wraith;
import com.glasspixel.glasspixeldungeon.actors.mobs.npcs.DirectableAlly;
...
import com.glasspixel.glasspixeldungeon.effects.particles.ShaftParticle;
...
import com.glasspixel.glasspixeldungeon.scenes.CellSelector;
import com.glasspixel.glasspixeldungeon.scenes.GameScene;
import com.glasspixel.glasspixeldungeon.scenes.PixelScene;
import com.glasspixel.glasspixeldungeon.sprites.GhostSprite;
...
import com.glasspixel.glasspixeldungeon.windows.WndBlacksmith;
import com.glasspixel.glasspixeldungeon.windows.WndQuest;
import com.glasspixel.glasspixeldungeon.windows.WndUseItem;
...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (GlassPixelDungeon.scene() instanceof GameScene || GlassPixelDungeon.scene() instanceof AlchemyScene)){
	...
	public static class GhostHero extends DirectableAlly {
		...
		public void sayAppeared(){
			...
			if (GlassPixelDungeon.scene() instanceof GameScene) {
				Sample.INSTANCE.play( Assets.Sounds.GHOST );
			}
		}
