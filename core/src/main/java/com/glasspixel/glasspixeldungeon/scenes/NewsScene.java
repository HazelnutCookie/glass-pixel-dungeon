...
import com.glasspixel.glasspixeldungeon.services.news.NewsArticle;
...
import com.glasspixel.glasspixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				...
				GlassPixelDungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			GlassPixelDungeon.scene().addToFront(new WndArticle(article));
		}
	}
