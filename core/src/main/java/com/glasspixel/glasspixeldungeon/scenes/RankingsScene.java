...
import com.glasspixel.glasspixeldungeon.windows.WndDailies;
import com.glasspixel.glasspixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					GlassPixelDungeon.scene().addToFront(new WndDailies());
				}
