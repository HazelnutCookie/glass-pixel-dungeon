...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (GlassPixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) GlassPixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (GlassPixelDungeon.scene() instanceof GameScene) {
			...
			GlassPixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (GlassPixelDungeon.scene() instanceof GameScene) {
					...
					GlassPixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};
