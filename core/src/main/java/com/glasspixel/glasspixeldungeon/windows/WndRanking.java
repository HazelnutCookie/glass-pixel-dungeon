...
import com.glasspixel.glasspixeldungeon.ui.BadgesGrid;
import com.glasspixel.glasspixeldungeon.ui.BadgesList;
...
import com.glasspixel.glasspixeldungeon.ui.ItemSlot;
import com.glasspixel.glasspixeldungeon.ui.RedButton;
import com.glasspixel.glasspixeldungeon.ui.RenderedTextBlock;
import com.glasspixel.glasspixeldungeon.ui.TalentButton;
import com.glasspixel.glasspixeldungeon.ui.TalentsPane;
...
import com.glasspixel.glasspixeldungeon.ui.Button;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						GlassPixelDungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						GlassPixelDungeon.scene().addToFront(new WndOptions(new Image(icon),
