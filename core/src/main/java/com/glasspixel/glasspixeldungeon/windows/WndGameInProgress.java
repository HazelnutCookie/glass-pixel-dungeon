...
import com.glasspixel.glasspixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				GlassPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				GlassPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
