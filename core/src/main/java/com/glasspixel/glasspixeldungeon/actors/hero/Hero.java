...
import com.glasspixel.glasspixeldungeon.actors.mobs.Monk;
...
import com.glasspixel.glasspixeldungeon.scenes.SurfaceScene;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			GlassPixelDungeon.switchScene(AlchemyScene.class);
			return false;
